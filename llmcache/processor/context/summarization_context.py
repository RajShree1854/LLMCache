...
from LLMCache.processor import ContextProcess
from LLMCache.utils import import_huggingface
...
class SummarizationContextProcess(ContextProcess):
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.context.summarization_context import SummarizationContextProcess
