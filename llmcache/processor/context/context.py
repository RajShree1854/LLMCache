...
class ContextProcess(metaclass=ABCMeta):
    ...
    By the way, the LLMCache will acquire more information and get a more accurate embedding vector.

    Example:
        .. code-block:: python

            from LLMCache.processor.context import SummarizationContextProcess
    ...
    def pre_process(self, data: Dict[str, Any], **params: Dict[str, Any]) -> (Any, Any):
        """ pre-process function, it's used as the LLMCache initialization param -- pre_embedding_func.
