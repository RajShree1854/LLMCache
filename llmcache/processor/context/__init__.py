...
summarization = LazyImport(
    ...
    globals(),
    "LLMCache.processor.context.summarization_context",
)
selective = LazyImport(
    "selective_context", globals(), "LLMCache.processor.context.selective_context"
)
concat = LazyImport(
    "concat_context", globals(), "LLMCache.processor.context.concat_context"
)
