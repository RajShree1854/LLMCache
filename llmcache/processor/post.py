...
from LLMCache.utils import softmax
...
def random_one(messages: List[Any]) -> Any:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.post import random_one
...
def first(messages: List[Any]) -> Any:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.post import first
...
def nop(messages: List[Any]) -> Any:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.post import nop
...
def llm_semantic_verification(
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.post import llm_semantic_verification
