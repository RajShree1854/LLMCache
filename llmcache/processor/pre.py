...
def last_content(data: Dict[str, Any], **_: Dict[str, Any]) -> Any:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import last_content
...
def last_content_without_prompt(data: Dict[str, Any], **params: Dict[str, Any]) -> Any:
    ...
    :param data: the user llm request data
    :type data: Dict[str, Any]
    :param params: the special LLMCache params, like prompts param in the cache object
    :type params: Dict[str, Any]

    Example:
        .. code-block:: python

            from LLMCache.processor.pre import last_content_without_prompt
...
def last_content_without_template(data: Dict[str, Any], **params: Dict[str, Any]) -> Any:
    ...
    :Example with str template:
        .. code-block:: python
            ...
            from LLMCache import Config
            from LLMCache.processor.pre import last_content_without_template
...
def all_content(data: Dict[str, Any], **_: Dict[str, Any]) -> Any:
    ...
    :Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import all_content
...
def nop(data: Dict[str, Any], **_: Dict[str, Any]) -> Any:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import nop
...
def get_prompt(data: Dict[str, Any], **_: Dict[str, Any]) -> Any:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import get_prompt
...
def get_file_name(data: Dict[str, Any], **_: Dict[str, Any]) -> str:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import get_file_name
...
def get_file_bytes(data: Dict[str, Any], **_: Dict[str, Any]) -> bytes:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import get_file_bytes
...
def get_input_str(data: Dict[str, Any], **_: Dict[str, Any]) -> str:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import get_input_str
...
def get_input_image_file_name(data: Dict[str, Any], **_: Dict[str, Any]) -> str:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import get_input_image_file_name
...
def get_image_question(data: Dict[str, Any], **_: Dict[str, Any]) -> str:  # pragma: no cover
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import get_image_question
...
def get_image(data: Dict[str, Any], **_: Dict[str, Any]) -> str:  # pragma: no cover
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import get_image
...
def get_inputs(data: Dict[str, Any], **_: Dict[str, Any]):
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import get_inputs
...
def get_messages_last_content(data: Dict[str, Any], **_: Any) -> str:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import get_messages_last_content
...
def get_openai_moderation_input(data: Dict[str, Any], **_: Dict[str, Any]) -> str:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import get_openai_moderation_input
...
def concat_all_queries(data: Dict[str, Any], **params: Dict[str, Any]) -> Any:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.processor.pre import concat_all_queries
