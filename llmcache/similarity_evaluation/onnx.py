...
class OnnxModelEvaluation(SimilarityEvaluation):
    ...
    :param model: model name of OnnxModelEvaluation. Default is 'LLMCache/albert-duplicate-onnx'.
    :type model: str

    Example:
        .. code-block:: python

            from LLMCache.similarity_evaluation import OnnxModelEvaluation
    ...
    def __init__(self, model: str = "LLMCache/albert-duplicate-onnx"):
