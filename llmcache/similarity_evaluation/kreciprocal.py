...
from LLMCache.manager.vector_data.base import VectorBase
...
class KReciprocalEvaluation(SearchDistanceEvaluation):
    ...
    :type vectordb: LLMCache.manager.vector_data.base.VectorBase
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.similarity_evaluation import KReciprocalEvaluation
            from LLMCache.manager.vector_data.faiss import Faiss
            from LLMCache.manager.vector_data.base import VectorData
            import numpy as np
