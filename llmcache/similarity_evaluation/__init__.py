...
from LLMCache.similarity_evaluation.similarity_evaluation import SimilarityEvaluation
...
onnx = LazyImport("onnx", globals(), "LLMCache.similarity_evaluation.onnx")
np = LazyImport("np", globals(), "LLMCache.similarity_evaluation.np")
distance = LazyImport("simple", globals(), "LLMCache.similarity_evaluation.distance")
exact_match = LazyImport(
    "exact_match", globals(), "LLMCache.similarity_evaluation.exact_match"
)
kreciprocal = LazyImport(
    "kreciprocal", globals(), "LLMCache.similarity_evaluation.kreciprocal"
)
cohere = LazyImport(
    "cohere", globals(), "LLMCache.similarity_evaluation.cohere_rerank"
)
sequence_match = LazyImport(
    "sequence_match", globals(), "LLMCache.similarity_evaluation.sequence_match"
)
time = LazyImport(
    "time", globals(), "LLMCache.similarity_evaluation.time"
)
...
sbert_crossencoder = LazyImport(
    "sbert_crossencoder", globals(), "LLMCache.similarity_evaluation.sbert_crossencoder"
)

def OnnxModelEvaluation(model="LLMCache/albert-duplicate-onnx"):
