...
from LLMCache.adapter.api import _get_model
...
class SequenceMatchEvaluation(SimilarityEvaluation):
    ...
    :type embedding_extractor: LLMCache.embedding.base.BaseEmbedding


    Example:
        .. code-block:: python

            from LLMCache.similarity_evaluation import SequenceMatchEvaluation
