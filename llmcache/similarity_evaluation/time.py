...
from LLMCache.adapter.api import _get_eval
...
class TimeEvaluation(SimilarityEvaluation):
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.manager.scalar_data.base import CacheData
            from LLMCache.similarity_evaluation import TimeEvaluation
