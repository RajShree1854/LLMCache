...
from LLMCache.config import Config
from LLMCache.embedding.string import to_embeddings as string_embedding
...
from LLMCache.report import Report
from LLMCache.similarity_evaluation import ExactMatchEvaluation
from LLMCache.similarity_evaluation import SimilarityEvaluation
from LLMCache.utils import import_openai
from LLMCache.utils.cache_func import cache_all
from LLMCache.utils.log import llmcache_log


class Cache:
    """LLMCache core object.
    ...
    def init(
        ...
        """Pass parameters to initialize LLMCache.
