...
from LLMCache.processor.check_hit import check_hit_session
from LLMCache.utils.log import llmcache_log


class Session:
    """
    Session for LLMCache. Session can isolate the context of each connection, and can also filter the results after recall,
    ...
    Example:
        .. code-block:: python
            ...
            # run ChatCompletion model with LLMCache on session
    ...
    def drop(self):
        ...
        llmcache_log.info("Deleting data in the session: %s.", self.name)
