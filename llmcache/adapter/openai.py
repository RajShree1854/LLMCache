...
from LLMCache.adapter.adapter import aadapt, adapt
from LLMCache.adapter.base import BaseCacheLLM
from LLMCache.manager.scalar_data.base import Answer, DataType
from LLMCache.utils import import_openai, import_pillow
from LLMCache.utils.error import wrap_error
from LLMCache.utils.response import (
...
from LLMCache.utils.token import token_counter
...
class ChatCompletion(openai.ChatCompletion, BaseCacheLLM):
    ...
    Example:
        .. code-block:: python
            ...
            # run ChatCompletion model with LLMCache
...
class Completion(openai.Completion, BaseCacheLLM):
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.adapter import openai
            # run Completion model with LLMCache
...
class Audio(openai.Audio):
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.adapter import openai
            # run audio transcribe model with LLMCache
...
class Image(openai.Image):
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.adapter import openai
            # run image generation model with LLMCache
...
class Moderation(openai.Moderation, BaseCacheLLM):
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.adapter import openai
            from LLMCache.adapter.api import init_similar_cache
