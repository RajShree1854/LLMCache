...
import LLMCache.processor.post
import LLMCache.processor.pre
from LLMCache import Cache, cache, Config
from LLMCache.adapter.adapter import adapt
from LLMCache.embedding import (
    Onnx,
    Huggingface,
    SBERT,
    FastText,
...
from LLMCache.embedding.base import BaseEmbedding
from LLMCache.manager import manager_factory
from LLMCache.manager.data_manager import DataManager
from LLMCache.processor.context import (
...
from LLMCache.similarity_evaluation import (
...
from LLMCache.utils import import_ruamel
...
def put(prompt: str, data: Any, **kwargs) -> None:
    """put api, put qa pair information to LLMCache
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.adapter.api import put
            from LLMCache.processor.pre import get_prompt
...
def get(prompt: str, **kwargs) -> Any:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.adapter.api import put, get
            from LLMCache.processor.pre import get_prompt
...
def init_similar_cache(
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.adapter.api import put, get, init_similar_cache
...
def init_similar_cache_from_config(config_dir: str, cache_obj: Optional[Cache] = None):
    ...
    storage_config.setdefault("data_dir", "llmcache_data")
...
def _get_pre_func(pre_process):
    return getattr(LLMCache.processor.pre, pre_process)
...
def _get_post_func(post_process):
    return getattr(LLMCache.processor.post, post_process)
