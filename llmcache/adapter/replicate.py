from LLMCache.utils.error import CacheError
from LLMCache.adapter.adapter import adapt
from LLMCache.utils import import_replicate
from LLMCache.manager.scalar_data.base import DataType, Question, Answer
...
class Client(replicate.client.Client):
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.adapter import replicate
            from LLMCache.processor.pre import get_input_str
            from LLMCache.embedding import Timm
            from LLMCache.similarity_evaluation.onnx import OnnxModelEvaluation
            ...
            # run replicate clinet with LLMCache
