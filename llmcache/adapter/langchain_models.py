...
from LLMCache.adapter.adapter import adapt, aadapt
from LLMCache.core import cache
from LLMCache.manager.scalar_data.base import Answer, DataType
from LLMCache.session import Session
from LLMCache.utils import import_langchain
...
class LangChainLLMs(LLM):
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.adapter.langchain_models import LangChainLLMs
            # run llm with LLMCache
...
class LangChainChat(BaseChatModel):
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.adapter.langchain_models import LangChainChat
            # run chat model with LLMCache
