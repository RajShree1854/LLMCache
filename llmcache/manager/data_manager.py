...
from LLMCache.manager.eviction import EvictionBase
from LLMCache.manager.eviction.distributed_cache import NoOpEviction
from LLMCache.manager.eviction_manager import EvictionManager
from LLMCache.manager.object_data.base import ObjectBase
from LLMCache.manager.scalar_data.base import (
    CacheStorage,
    CacheData,
    DataType,
    Answer,
...
from LLMCache.manager.vector_data.base import VectorBase, VectorData
from LLMCache.utils.error import CacheError, ParamError
from LLMCache.utils.log import llmcache_log
...
class MapDataManager(DataManager):
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.manager import get_data_manager
...
class SSDataManager(DataManager):
    ...
    :param s: CacheStorage to manager the scalar data, it can be generated with :meth:`LLMCache.manager.CacheBase`.
    :type s: CacheStorage
    :param v: VectorBase to manager the vector data, it can be generated with :meth:`LLMCache.manager.VectorBase`.
    :type v:  VectorBase
    :param o: ObjectBase to manager the object data, it can be generated with :meth:`LLMCache.manager.ObjectBase`.
    :type o:  ObjectBase
    :param e: EvictionBase to manager the eviction data, it can be generated with :meth:`LLMCache.manager.EvictionBase`.
    :type e:  EvictionBase
    """
    ...
    def save(self, question, answer, embedding_data, **kwargs):
        ...
        Example:
            .. code-block:: python
                ...
                import numpy as np
                from LLMCache.manager import get_data_manager, CacheBase, VectorBase
