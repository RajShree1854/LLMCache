from LLMCache.utils.error import NotFoundError, ParamError
...
class VectorBase:
    ...
    :type port: str
    :param user: the user for Milvus Cloud, defaults to "".
    :type user: str
    :param password: the password for Milvus Cloud, defaults to "".
    :type password: str
    :param secure: whether it is https with Milvus Cloud, defaults to False.
    :type secures: bool
    ...
    :param collection_name: the name of the collection for Milvus vector database, defaults to 'LLMCache'.
    ...
    :type index_params: dict
    :param collection_name: the prefix of the table for PostgreSQL pgvector, defaults to 'LLMCache'.
    :type collection_name: str
    ...
    def get(name, **kwargs):
        ...
        if name == "milvus":
            from LLMCache.manager.vector_data.milvus import Milvus
            ...
            from LLMCache.manager.vector_data.faiss import Faiss
            ...
            from LLMCache.manager.vector_data.chroma import Chromadb
            ...
            from LLMCache.manager.vector_data.hnswlib_store import Hnswlib
            ...
            from LLMCache.manager.vector_data.pgvector import PGVector
            ...
            from LLMCache.manager.vector_data.docarray_index import DocArrayIndex

            index_path = kwargs.pop("index_path", "./docarray_index.bin")
            vector_base = DocArrayIndex(index_file_path=index_path, top_k=top_k)
        elif name == "usearch":
            from LLMCache.manager.vector_data.usearch import USearch
            ...
            from LLMCache.manager.vector_data.redis_vectorstore import RedisVectorStore
            ...
            from LLMCache.manager.vector_data.qdrant import QdrantVectorStore
            ...
            from LLMCache.manager.vector_data.weaviate import Weaviate
            ...
            class_name = kwargs.get("class_name", "LLMCache")
