...
from LLMCache.utils import import_redis
...
class RedisVectorStore(VectorBase):
    ...
    :type dimension: int
    :param collection_name: the name of the index for Redis, defaults to "LLMCache".
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.manager import VectorBase
    ...
    def _check_index_exists(self, index_name: str) -> bool:
        ...
        try:
            ...
            llmcache_log.info("Index does not exist")
            return False
        llmcache_log.info("Index already exists")
        return True
