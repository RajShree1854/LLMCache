...
class ObjectBase:
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.manager import ObjectBase
    ...
    def get(name, **kwargs):
        if name == "local":
            from LLMCache.manager.object_data.local_storage import LocalObjectStorage  # pylint: disable=import-outside-toplevel
            object_base = LocalObjectStorage(kwargs.get("path", "./local_obj"))
        elif name == "s3":
            from LLMCache.manager.object_data.s3_storage import S3Storage  # pylint: disable=import-outside-toplevel
