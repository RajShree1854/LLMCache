from LLMCache.utils import import_sql_client
from LLMCache.utils.error import NotFoundError
...
class CacheBase:
    ...
    :type sql_url: str
    :param table_name: the table name for sql database, defaults to 'LLMCache'.
    :type table_name: str
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.manager import CacheBase
    ...
    def get(name, **kwargs):
        if name in [
            ...
            from LLMCache.manager.scalar_data.sql_storage import SQLStorage
            ...
            from LLMCache.manager.scalar_data.mongo import MongoStorage
            ...
            from LLMCache.manager.scalar_data.redis_storage import RedisCacheStorage
            ...
            from LLMCache.manager.scalar_data.dynamo_storage import DynamoStorage
