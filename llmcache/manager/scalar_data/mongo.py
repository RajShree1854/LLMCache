...
from LLMCache.utils import import_mongodb
...
class MongoStorage(CacheStorage):
    ...
    By default, data is stored 'LLMCache' database and following collections are created to store the data
        1. 'sessions'
        2. 'answers'
        3. 'questions'
        4. 'question_deps'
    ...
    :type host: int
    :param dbname: database name, default value 'LLMCache'
    :type host: str
    :param : Mongo database name, default value 'LLMCache'
    :type host: str
    ...
    Example:
        .. code-block:: python
            ...
            from LLMCache.manager import CacheBase, manager_factory
