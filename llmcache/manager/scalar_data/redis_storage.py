...
class RedisCacheStorage(CacheStorage):
    ...
    For example, for a global_key_prefix ='LLMCache', keys would be constructed would look like this:
    LLMCache:questions:abc123
    ...
    def __init__(
            self,
            global_key_prefix: str = "LLMCache",
            host: str = "localhost",
            port: int = 6379,
            maxmemory: str = None,
            policy: str = None,
