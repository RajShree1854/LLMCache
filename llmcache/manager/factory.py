...
from LLMCache.manager import CacheBase, VectorBase, ObjectBase
from LLMCache.manager.data_manager import SSDataManager, MapDataManager
...
def manager_factory(manager="map",
    ...
    if  scalar == "redis" and eviction_manager == "redis":
        ...
        llmcache_log.info("Since Scalar Storage and Eviction manager are both redis, "
